...
#### 주의사항
1) 일부 상품(![예시](https://mcn.hd-dfs.com/shop/gd/dtl/goos.do?onlnGoosCd=10229250009701))들은 별도의 UI를 사용하고 있습니다. 현 시점에는 이렇게 별도의 UI를 사용하는 상품들에는 상품 분석 코드가 누락된채 사이트에 올라와 있습니다.
