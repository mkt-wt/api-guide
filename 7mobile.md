...
2) `성별코드`, `연령대코드`, `현재요금제코드`, `기존요금제코드`는 아래 표에 있는 코드 값을 참고해 입력해 주세요.
...
LTE 음성 V4	| 00000259
LTE 음성 V5	| 00000260
LTE 공부 LEVEL2	| 00000224
LTE 공부 LEVEL1	| 00000223
...
_TRK_PNC_SUB_TP2 = "가입유형"; //'번호이동', '신규', '기기변경' 중 1가지 입력
_TRK_PNC_SUB_TP3 = "할인방법"; //'공시지원금' or '선택약정' 중 1가지 입력, 카드할인은 입력하지 않음
_TRK_PNC_SUB_TP4 = "유심명칭"; //'일반유심' or 'NFC유심' 중 1가지 입력
_TRK_PNC_SUB_TP5 = "요금제코드"; //유저가 구매한 요금제 코드를 입력하되, 코드 앞부분의 영문(PD)를 제거한 8자리 숫자로 입력, 로그인시 세팅하는 요금제코드의 형식과 동일함
...
_TRK_PNC_SUB_TP5 = "00000228;00000228";
_TRK_PNG = "000;001";
_TRK_EA = "1;1";
